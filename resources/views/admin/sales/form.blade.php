...
<section class="dash_content_app">
   ...
   <div class="dash_content_app_box">
      <div class="nav">
         ...
         @if(! isset($sale))
            <form action="{{ route('sales.store') }}" method="post" class="app_form"
                     ...
                     <select name="client_id" class="select2">
                        ...
                        @foreach($clients as $client)
                           <option value="{{ $client->id }}"
                              {{ set_selected($client->id, old('client_id')) }}>
            ...
            <div class="nav_tabs_content">
               ...
               <div class="label_g2">
                  ...
                  <label class="label">
                     ...
                     <input type="text" id="discount" name="discount" class="mask-money" onblur="updateDiscount(this)"
                        autocomplete="off"
