            ...
            <div id="data">
              ...
              <div class="label_g2">
                <label class="label">
                  ...
                  <input type="text" name="name" placeholder="Nome Completo" value="{{ old('name', $client->name ?? null) }}"
                    autocomplete="off" />
              ...
              <div class="label_g2">
                ...
                <label class="label">
                  ...
                  <input type="tel" name="phone_secondary" class="mask-cell" placeholder="Número do Telefonce com DDD"
                  ...
                  <div class="label_g2">
                    <label class="label">
                      ...
                      <input type="tel" name="zipcode" class="mask-zipcode zip_code_search" placeholder="Digite o CEP"
                        value="{{ old('zipcode', $client->zipcode ?? null) }}" />
