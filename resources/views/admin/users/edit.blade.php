          ...
          <div id="data">
              ...
              <label class="label">
                ...
                <select name="company_id" class="select2">
                  ...
                  <option value="{{ $company->id }}"
                    {{ set_selected($company->id, old('company_id', $user->company_id ?? null)) }}>
            ...
            <div class="label_g2">
              <label class="label">
                ...
                <select name="genre">
                  <option value="male"
                    {{ (old('genre') == 'male' ? 'selected' : ($user->genre == 'male' ? 'selected' : '')) }}>Masculino
                  </option>
                  <option value="female"
                  ...
                  <option value="other"
                    {{ (old('genre') == 'other' ? 'selected' : ($user->genre == 'other' ? 'selected' : '')) }}>Outros
                  </option>
                </select>
              </label>
