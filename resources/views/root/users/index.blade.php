...
<section class="dash_content_app">
   <header class="dash_content_app_header">
      ...
      <div class="dash_content_app_header_actions">
         ...
         <a href="{{ route('root.users.create') }}" class="btn btn-orange icon-user ml-1">Criar Usuario</a>
      </div>
   </header>
         ...
         <table id="dataTable" class="nowrap stripe" width="100" style="width: 100% !important;">
            ...
            <tbody>
               ...
               <tr>
                  ...
                  <td>{{ $user->company->social_name }}</td>
                  <td>
                     <a href="{{ route('root.users.edit', ['user' => $user->id]) }}" class="text-blue icon-pencil-square-o"
                     ...
                     <form id="btn-delete-{{ $user->id }}" action="{{ route('root.users.destroy', ['user' => $user->id]) }}"
